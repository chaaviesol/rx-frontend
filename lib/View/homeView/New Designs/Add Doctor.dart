...
class AddDoctorNew extends StatefulWidget {
  @override
  _AddDoctorNewState createState() => _AddDoctorNewState();
}

class _AddDoctorNewState extends State<AddDoctorNew> {
          ...
          child: Padding(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  Text('Personal details',style: text50012black,),
                  SizedBox(height: 10,),
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Type',style: text50012black,),
                            SizedBox(height: 10,),
                            Container(
                              decoration: BoxDecoration(
                                  color: AppColors.textfiedlColor,
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10,),
                      Text('Exstation',style: text50012black,),
                      SizedBox(height: 10,),
                      Container(
                        decoration: BoxDecoration(
                            color: AppColors.textfiedlColor,
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Date 2',style: text50012black,),
                            SizedBox(height: 10,),
                            Container(
                              decoration: BoxDecoration(
                                  color: AppColors.textfiedlColor,
